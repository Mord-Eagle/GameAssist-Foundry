...
- [Foundry VTT Profile](MECHSUITS%20Profile%20-%20Foundry%20VTT%20v1.0.0.md) -
  additive Foundry lifecycle, Document, authority, privacy, UI, and system
  rules.
- [MECHSUITS Notice](MECHSUITS-NOTICE.md) - ownership and permitted project
  use of the MECHSUITS specifications.

## Licensing

GameAssist-Foundry source is licensed under the repository's MIT License unless
a file or notice states otherwise. MECHSUITS is proprietary to Mord Eagle and
is governed by `MECHSUITS-NOTICE.md`, not the MIT License.
